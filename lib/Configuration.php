...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://public-api.bridgemanimages.com/1.0';
    ...
    {
        $report  = 'PHP SDK (Bridgeman\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.1.0-oas3' . PHP_EOL;
